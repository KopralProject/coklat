...
echo -e "         Auther : ${green}KaisarVPN ${NC}${YELLOW}(${NC} ${green}F75.ID ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/KopralProject/delta/refs/heads/main/"
start=$(date +%s)
secs_to_human() {
...
wget https://raw.githubusercontent.com/KopralProject/delta/refs/heads/main/Cdy/menu.zip
chmod +x menu/*
