...
### INSTALL SCRIPT 
```
apt install -y && apt update -y && apt upgrade -y && wget -q https://raw.githubusercontent.com/KopralProject/coklat/refs/heads/main/install.sh && chmod +x install.sh && ./install.sh
```
